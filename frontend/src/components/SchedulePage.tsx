...
interface ScheduleKPI {
    total_cost: number          // 총 인건비
    total_ot_hours: number      // 총 OT 시간
    night_bias_index: number    // 야간 편중 지수
    fulfillment_rate: number    // 충족률
}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
                        ...
                        <div className="bg-white rounded-lg shadow-md p-6">
                            ...
                            <div className="text-3xl font-bold text-purple-600">
                                {(kpi.total_cost / 1000000).toFixed(1)}M
                            </div>
                        ...
                        <div className="bg-white rounded-lg shadow-md p-6">
                            ...
                            <div className="text-3xl font-bold text-blue-600">
                                {(kpi.night_bias_index * 100).toFixed(0)}%
                            </div>
                            <div className="text-xs text-gray-500 mt-1">
                                균형도
                            </div>
